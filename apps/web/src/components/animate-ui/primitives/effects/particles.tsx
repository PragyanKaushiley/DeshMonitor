...
// not hand-authored here). motion's MotionStyle generics conflict with this
// project's exactOptionalPropertyTypes; not worth hand-patching third-party
// generic plumbing. Runtime behavior is unaffected.
'use client';
